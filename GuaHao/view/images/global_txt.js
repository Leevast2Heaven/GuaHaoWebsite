...
strFrame+='             Author=meizz align=right><input Author=meizz type=button class=button value=" >" style="cursor:hand" onclick="parent.meizzNextM()" onfocus="this.blur()" title="向后翻 1 月" class=button style="font-size: 12px; height: 20px"></input> ';
